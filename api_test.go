...
var (
	...
	photoURL            = "https://github.com/animber-coder/echosphere/raw/master/assets/tests/echosphere_test.png"
	animationURL        = "https://github.com/animber-coder/echosphere/raw/master/assets/tests/animation.mp4"
	audioURL            = "https://github.com/animber-coder/echosphere/raw/master/assets/tests/audio.mp3"
	documentURL         = "https://github.com/animber-coder/echosphere/raw/master/assets/tests/document.pdf"
	logoInvURL          = "https://github.com/animber-coder/echosphere/raw/master/assets/tests/echosphere_thumb_inv.jpg"
	videoURL            = "https://github.com/animber-coder/echosphere/raw/master/assets/tests/video.webm"
	videoNoteURL        = "https://github.com/animber-coder/echosphere/raw/master/assets/tests/video_note.mp4"
	voiceURL            = "https://github.com/animber-coder/echosphere/raw/master/assets/tests/audio.mp3"
...
func TestSendPhotoBytes(t *testing.T) {
	data, err := openBytes("assets/tests/echosphere_test.png")
	...
	_, err = api.SendPhoto(
		NewInputFileBytes("echosphere_test.png", data),
		chatID,
		&PhotoOptions{
...
func TestSendAudioThumbnail(t *testing.T) {
	_, err := api.SendAudio(
		...
		&AudioOptions{
			Caption:   "TestSendAudio",
			Thumbnail: NewInputFilePath("assets/tests/echosphere_thumb.jpg"),
		},
	)
...
func TestSendPaidMediaPhotoBytes(t *testing.T) {
	...
	_, err = api.SendPaidMedia(
		...
		[]GroupableInputMedia{
			InputPaidMediaPhoto{
				Type:  InputPaidMediaTypePhoto,
				Media: NewInputFileBytes("echosphere_test.png", data),
			},
		},
		&PaidMediaOptions{
	...
	_, err := api.SendMediaGroup(
		...
		[]GroupableInputMedia{
			InputMediaAudio{
				...
				Thumbnail: NewInputFilePath("assets/tests/echosphere_thumb_inv.jpg"),
...
func TestSetChatTitle(t *testing.T) {
	_, err := api.SetChatTitle(
		groupID,
		"Echosphere Coverage Supergroup",
	)
...
func TestSetChatDescription(t *testing.T) {
	_, err := api.SetChatDescription(
		groupID,
		fmt.Sprintf(
			"This supergroup is used to test some of the methods of the Echosphere library for Telegram bots.\n\nLast changed: %d",
			time.Now().Unix(),
		),
	)
